...
## Sketch and Code
💡 The main sketch is in [ESP8266_LED_MATRIX_TEXT_DISPLAY.ino](ESP8266_LED_MATRIX_TEXT_DISPLAY.ino), but you can also view the syntax-highlighted C++ version here: [LEDMatrix_WiFi_Code.cpp](ESP8266_LED_Matrix_code.cpp)
...
3. Open the [`ESP8266_LED_MATRIX_TEXT_DISPLAY.ino`](ESP8266_LED_MATRIX_TEXT_DISPLAY.ino) file in the Arduino IDE.

4. Select the correct **board** (`NodeMCU 1.0`, `Wemos D1 Mini`, or other ESP8266), **port**, and **upload speed** (typically 115200).

5. Flash or Upload the sketch to your ESP8266.
